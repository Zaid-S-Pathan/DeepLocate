            ...
            <div className="w-full relative pb-10 px-6 xl:px-0">
                ...
                <div className="pt-12 lg:flex items-center relative z-10 container mx-auto">
                    ...
                    <div  role="contentinfo"  className="w-full lg:w-1/2 h-full">
                        <p tabIndex="0" className="text-indigo-700 uppercase text-2xl mb-4">Let's locate your close one's with our recognition systems</p>
                        <h1 tabIndex="0" className="text-indigo-700 text-4xl lg:text-6xl font-black mb-8">DeepLocate</h1>
                        <p tabIndex="0" className="text-gray-800 font-regular mb-8">Web App to help to locate the missing persons by the use of face recognition technology</p>
